...
## Section 16 - Deploying Angular Apps

### 313. Preparing a Project For Deployment: Building It For Production

Run `npm run build` to build the angualr project for production. It will add `dist` folder in your files that will contain files essential to put your website on the internet.